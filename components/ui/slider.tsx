      ...
      <SliderPrimitive.Control className="group/slider-control relative flex w-full touch-none items-center select-none in-data-[size=touch]:h-11 data-disabled:opacity-50 data-vertical:h-full data-vertical:min-h-40 data-vertical:w-auto data-vertical:flex-col">
        ...
        {Array.from({ length: _values.length }, (_, index) => (
          <SliderPrimitive.Thumb
            ...
            key={index}
            className="relative block size-3 shrink-0 rounded-none border border-ring bg-white ring-ring/50 transition-[color,box-shadow] select-none after:absolute after:-inset-2 hover:ring-1 focus-visible:ring-1 focus-visible:outline-hidden active:ring-1 disabled:pointer-events-none disabled:opacity-50 in-data-[size=touch]:size-6 in-data-[size=touch]:border-2 in-data-[size=touch]:border-primary"
          />
        ))}
