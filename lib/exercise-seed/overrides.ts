...
export const EXERCISE_OVERRIDES: Record<string, Tagging> = Object.fromEntries([
  ...
  t("Dumbbell_Bench_Press_with_Neutral_Grip", ["chest"], ["front_delts", "triceps"], "horizontal_push"),
  ...
  t("Pushups_Close_and_Wide_Hand_Positions", ["chest"], ["front_delts", "triceps"], "horizontal_push"),
  ...
  t("Alternating_Cable_Shoulder_Press", ["front_delts"], ["side_delts", "triceps"], "vertical_push"),
  t("Leverage_Shoulder_Press", ["front_delts"], ["side_delts", "triceps"], "vertical_push"),
  t("Two-Arm_Kettlebell_Military_Press", ["front_delts"], ["side_delts", "triceps"], "vertical_push"),
  ...
  t("Standing_Barbell_Press_Behind_Neck", ["front_delts", "side_delts"], ["triceps"], "vertical_push"),
  ...
  t("Bent_Over_Two-Dumbbell_Row", ["upper_back", "lats"], ["biceps", "rear_delts"], "horizontal_pull"),
  t(
  ...
  t("Box_Squat_with_Bands", ["quads", "glutes"], ["hamstrings", "adductors", "lower_back"], "squat"),
  t("Box_Squat_with_Chains", ["quads", "glutes"], ["hamstrings", "adductors", "lower_back"], "squat"),
  ...
  t("Axle_Deadlift", ["hamstrings", "glutes"], ["lower_back", "quads", "traps", "forearms"], "hinge"),
  t(
    "Trap_Bar_Deadlift",
    ["quads", "glutes"],
  ...
  t("Stiff-Legged_Dumbbell_Deadlift", ["hamstrings", "glutes"], ["lower_back", "forearms"], "hinge"),
