...
export const account = pgTable(
  ...
  {
    id: text("id").primaryKey(),
    // better-auth 1.7 added `issuer` to the account model. The last published
    // CLI (1.4.21, deprecated) still emits the 1.4 shape, so this field and the
    // unique index below are maintained by hand against getAuthTables().
